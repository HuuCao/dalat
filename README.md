...
- **Tab `💰 Quỹ`:** cảnh báo và khoản không khớp địa điểm (nếu có); thẻ tổng quan — `Quỹ còn` chữ lớn, thanh tiến độ `Đã chi … / dự kiến … · 4%`, ba ô nhỏ `📥 Đã góp` · `💸 Đã chi` · `✅ Dư dự kiến` (hoặc `⚠️ Thiếu dự kiến`); 🧮 quyết toán dạng bảng gọn — cột `Góp · Trả hộ · Chịu · Hoàn`, mỗi người một dòng: chữ cái đầu trong vòng tròn và tên, số không dấu nhưng tô màu theo công thức (góp và trả hộ xanh, chịu cam, 0 mờ); cột `Hoàn` ghi số tiền được hoàn màu xanh, ai phải nộp thêm ghi `Nộp …` màu cam, không hoàn không nộp ghi `0`; 📅 theo ngày — mỗi dòng có thanh tiến độ riêng, chưa chi thì ghi `Dự kiến …`, phát sinh thành nhãn cam; 🧾 chi phí chung dạng thẻ (vé xe, khách sạn, xe máy, phát sinh chung); sổ sách với nút chuyển `Sổ chi` / `Góp quỹ` — sổ chi nhóm theo Chung → Ngày 1…N → Không khớp, mỗi nhóm có tổng, mỗi khoản ghi tên địa điểm gọn và số tiền; góp quỹ mỗi khoản một hàng kèm dòng tổng; nút mở Form và Sheet. Tab `Tất cả` không gồm tab này.
