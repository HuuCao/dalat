...
- **Tab `💰 Quỹ`:** cảnh báo và khoản không khớp địa điểm (nếu có); thẻ tổng quan — `Quỹ còn` chữ lớn, thanh tiến độ `Đã chi … / dự kiến … · 4%`, ba ô nhỏ `📥 Đã góp` · `💸 Đã chi` · `✅ Dư dự kiến` (hoặc `⚠️ Thiếu dự kiến`); 🧮 quyết toán mỗi người hai dòng, không khung — chữ cái đầu trong vòng tròn, tên và kết quả chữ màu `Hoàn …` / `Nộp …` / `Đủ`, dòng dưới là `Góp +3tr · Trả hộ 0 · Chịu −110k` chia ba cột thẳng hàng (cộng xanh, trừ cam, 0 mờ); 📅 theo ngày — mỗi dòng có thanh tiến độ riêng, chưa chi thì ghi `Dự kiến …`, phát sinh thành nhãn cam; 🧾 chi phí chung dạng thẻ (vé xe, khách sạn, xe máy, phát sinh chung); sổ sách với nút chuyển `Sổ chi` / `Góp quỹ` — sổ chi nhóm theo Chung → Ngày 1…N → Không khớp, mỗi nhóm có tổng, mỗi khoản ghi tên địa điểm gọn và số tiền; góp quỹ mỗi khoản một hàng kèm dòng tổng; nút mở Form và Sheet. Tab `Tất cả` không gồm tab này.
